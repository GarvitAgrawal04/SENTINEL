...
**Generated:** 2026-09-23 09:03:20Z  
**Version:** 0.9.10  
...
|---|:---:|:---:|:---:|
| Attacks detected | **0/10** (0%) | **10/10** (100%) | **+10** |
| Benign twin false alarms | **0/10** | **0/10** | +0 |

Time-Warp catches **10/10** sleeper attacks (+10 over single-moment) with **0/10 false alarms** on benign twins.
...
*Reproduced automatically by `python bench/evidence.py` at 2026-09-23 09:03:20Z.*
