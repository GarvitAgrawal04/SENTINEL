# agency-agents --- Multi-agent orchestration framework
# D:\Repositories\agency-agents\CLAUDE.md

## What This Is
Multi-agent orchestration framework. Define agent roles, capabilities, and communication channels. Task delegation, result aggregation, and collaborative problem-solving across specialized AI agents.
...
### Overview
Multi-agent orchestration framework. This repository provides essential functionality for the autonomous
...
## OUTPUT CONTRACT
Delivers: Multi-agent orchestration framework.
