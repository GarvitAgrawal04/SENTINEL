# autoresearch
# D:\Repositories\autoresearch\CLAUDE.md

## What This Is
Automated research pipeline. Literature review, synthesis, citation management.

## When to Load This
- When task involves autoresearch functionality
...
### Overview
Automated research pipeline. Literature review, synthesis, citation management. This component integrates with the broader 300-repo
autonomous system through standardized CLAUDE.md contracts.

### Key Capabilities
| Capability | Description |
|---|---|
| Core functionality | Automated research pipeline. Literature review, synthesis, citation management. |
...
## OUTPUT CONTRACT
Delivers: Automated research pipeline. Literature review, synthesis, citation management.
