...
# D:\Repositories\agent-governance-toolkit\CLAUDE.md

## What This Is
AI agent governance and safety framework. Guardrails, permissions, audit trails.

## When to Load This
- When task involves agent-governance-toolkit functionality
...
### Overview
AI agent governance and safety framework. Guardrails, permissions, audit trails. This component integrates with the broader 300-repo
autonomous system through standardized CLAUDE.md contracts.

### Key Capabilities
| Capability | Description |
|---|---|
| Core functionality | AI agent governance and safety framework. Guardrails, permissions, audit trails. |
...
## OUTPUT CONTRACT
Delivers: AI agent governance and safety framework. Guardrails, permissions, audit trails.
