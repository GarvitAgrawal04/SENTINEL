# activepieces
# D:\Repositories\activepieces\CLAUDE.md

## What This Is
Open-source Zapier alternative. No-code automation platform. 100+ integrations. Self-hosted. Visual workflow builder. Webhooks, scheduling, branching.

## When to Load This
- Tasks involving activepieces functionality
...
### Overview
Open-source Zapier alternative. No-code automation platform. 100+ integrations. Self-hosted. Visual workflow builder. Webhooks, scheduling, branching. This component integrates with the 300-repo autonomous system.

### Key Capabilities
| Capability | Description |
|---|---|
| Core | Open-source Zapier alternative. No-code automation platform. 100+ integrations. Self-hosted. Visual workflow builder. Webhooks, scheduling, branching. |
...
## OUTPUT CONTRACT
Delivers: Open-source Zapier alternative. No-code automation platform. 100+ integrations. Self-hosted. Visual workflow builder. Webhooks, scheduling, branching.
