# Agent-Skills-for-Context-Engineering --- Skill definitions and context engineering patterns for AI agents
# D:\Repositories\Agent-Skills-for-Context-Engineering\CLAUDE.md

## What This Is
Skill definitions and context engineering patterns for AI agents. Structured skill files (.skill.md), capability declarations, context window optimization, and agent specialization patterns for autonomous engineering systems.
...
### Overview
Skill definitions and context engineering patterns for AI agents. This repository provides essential functionality for the autonomous
...
| AI | langchainjs | LLM chain alternative |
...
## OUTPUT CONTRACT
Delivers: Skill definitions and context engineering patterns for AI agents.
