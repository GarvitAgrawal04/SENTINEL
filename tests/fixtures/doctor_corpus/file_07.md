# ace-step-ui
# D:\Repositories\ace-step-ui\CLAUDE.md

## What This Is
Web UI for ACE-Step music generation. Upload lyrics, select style, generate audio.

## When to Load This
- When task involves ace-step-ui functionality
...
### Overview
Web UI for ACE-Step music generation. Upload lyrics, select style, generate audio. This component integrates with the broader 300-repo
autonomous system through standardized CLAUDE.md contracts.

### Key Capabilities
| Capability | Description |
|---|---|
| Core functionality | Web UI for ACE-Step music generation. Upload lyrics, select style, generate audio. |
...
## OUTPUT CONTRACT
Delivers: Web UI for ACE-Step music generation. Upload lyrics, select style, generate audio.
