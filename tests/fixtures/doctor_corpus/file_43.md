# app-store-screenshots --- Generate app store screenshots and marketing assets
# D:\Repositories\app-store-screenshots\CLAUDE.md

## What This Is
Generate app store screenshots and marketing assets. AI-powered screenshot generation. Device frames, backgrounds, text overlays. For iOS App Store and Google Play Store listings.
...
- Integration with autonomous engineering system
...
### Overview
Generate app store screenshots and marketing assets. This component integrates with the broader platform through
standardized interfaces and follows established patterns for cross-department routing.

### Key Capabilities
| Capability | Description |
|---|---|
| Core functionality | Generate app store screenshots and marketing assets |
| API integration | REST/JSON standard interfaces |
| Docker support | Container deployment ready |
| Documentation | CLAUDE.md contract established |
| Error handling | Self-healing patterns active |
...
| Authentication failed | Check API keys, tokens, or credentials |
...
| Rate limited | Implement exponential backoff or increase limits |
...
|---|---|---|
| MARKETING | remotion | Primary integration partner |
| MARKETING | Penpot | Complementary tooling |
| MARKETING | Fooocus | Alternative or extension |
...
|---|---|---|
| Local dev | Direct installation | Development |
| Docker | Containerized | Standard production |
| Docker Compose | Multi-service | Full stack |
| Serverless | Cloud function | Event-driven |
| Edge | CDN/edge deployment | Low latency |
...
## OUTPUT CONTRACT
Delivers: Generate app store screenshots and marketing assets.
