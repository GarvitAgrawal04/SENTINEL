# ACE-Step-1.5
# D:\Repositories\ACE-Step-1.5\CLAUDE.md

## What This Is
AI composition engine for music generation. Produces full songs with lyrics, melody, and accompaniment.

## When to Load This
- When task involves ACE-Step-1.5 functionality
...
### Overview
AI composition engine for music generation. Produces full songs with lyrics, melody, and accompaniment. This component integrates with the broader 300-repo
autonomous system through standardized CLAUDE.md contracts.

### Key Capabilities
| Capability | Description |
|---|---|
| Core functionality | AI composition engine for music generation. Produces full songs with lyrics, melody, and accompaniment. |
...
## OUTPUT CONTRACT
Delivers: AI composition engine for music generation. Produces full songs with lyrics, melody, and accompaniment.
